      ...
      <body className="min-h-screen font-[family-name:var(--font-work-sans-var)]">
        ...
        >
          <a
            ...
            className="pointer-events-auto btn-primary !rounded-md !text-[10px] md:!text-[9px] tracking-tight md:tracking-tighter !py-2 md:!py-2 !px-4 md:!px-3 shadow-2xl hover:scale-105 transition-transform whitespace-nowrap"
          >
            ΞΕΚΙΝΑ ΠΡΟΠΟΝΗΣΗ
          </a>
        </div>
