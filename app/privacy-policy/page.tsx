...
const LAST_UPDATED = "24 Σεπτεμβρίου 2025";
        ...
        <div className="mx-auto max-w-[820px] px-5 md:px-8 lg:px-12 text-dark-gray leading-[1.8] text-lg space-y-10">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Περιηγούνται στην Ιστοσελίδα, όπου συλλέγονται cookies ή παρόμοιες τεχνολογίες (αναλυτικά στην Πολιτική Cookies).</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Τα δεδομένα παρέχονται άμεσα από εσάς όταν συμπληρώνετε φόρμες ή επικοινωνείτε μαζί μας. Επίσης, συλλέγουμε δεδομένα αυτόματα μέσω cookies κατά την περιήγηση. Δεν λαμβάνουμε προσωπικά δεδομένα από τρίτες πηγές.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Βελτίωση της εμπειρίας χρήστη και ανάλυση της επισκεψιμότητας (μέσω cookies).</li>
          ...
          <div>
            ...
            <p>
              Χρησιμοποιούμε cookies για να βελτιώνουμε την εμπειρία σας και να αναλύουμε την επισκεψιμότητα. Για λεπτομέρειες ανατρέξτε στην Πολιτική Cookies.
            </p>
          </div>
