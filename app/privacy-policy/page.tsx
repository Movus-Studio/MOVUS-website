...
const LAST_UPDATED = "18 Μαΐου 2026";
        ...
        <div className="mx-auto max-w-[820px] px-5 md:px-8 lg:px-12 text-dark-gray leading-[1.8] text-lg space-y-10">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Περιηγούνται στην Ιστοσελίδα. Χρησιμοποιούμε αναγκαία (essential) cookies για τη βασική λειτουργία και, μόνο με τη ρητή σας συγκατάθεση, στατιστικά cookies (Google Analytics) για ανώνυμη μέτρηση επισκεψιμότητας (λεπτομέρειες στην ενότητα 9 «Cookies»).</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              Τα δεδομένα παρέχονται άμεσα από εσάς όταν συμπληρώνετε φόρμες ή επικοινωνείτε μαζί μας. Συλλέγουμε επίσης ανώνυμα στατιστικά περιήγησης μέσω Google Analytics, αποκλειστικά εφόσον δώσετε τη συγκατάθεσή σας στο σχετικό banner. Δεν λαμβάνουμε δεδομένα από τρίτες πηγές.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Η Ιστοσελίδα μας χρησιμοποιεί δύο κατηγορίες cookies:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong className="text-movus-navy">Αναγκαία (essential) cookies:</strong> απαραίτητα για τη βασική λειτουργία (π.χ. ασφάλεια φορμών επικοινωνίας, αποθήκευση των επιλογών σας στο banner συγκατάθεσης, διατήρηση τεχνικών προτιμήσεων περιήγησης). Σύμφωνα με το άρθρο 4 παρ. 5 του ν. 3471/2006 και τις κατευθυντήριες γραμμές της Αρχής Προστασίας Δεδομένων, δεν απαιτείται προηγούμενη συγκατάθεση.
              </li>
              <li>
                <strong className="text-movus-navy">Στατιστικά cookies (Google Analytics):</strong> ενεργοποιούνται <strong className="text-movus-navy">μόνο</strong> εφόσον δώσετε τη ρητή συγκατάθεσή σας στο σχετικό banner. Χρησιμοποιούνται για ανώνυμη μέτρηση επισκεψιμότητας, ώστε να καταλαβαίνουμε ποιες σελίδες βοηθούν τους χρήστες μας. Οι διευθύνσεις IP ανωνυμοποιούνται. Πάροχος: Google Ireland Limited. Δείτε την{" "}
                <a
            ...
            <p className="mb-4">
              <strong className="text-movus-navy">Δεν χρησιμοποιούμε:</strong> διαφημιστικά cookies, pixels Meta/Facebook, ούτε εργαλεία στοχευμένης διαφήμισης. Δεν διαβιβάζουμε δεδομένα περιήγησης σε τρίτους για σκοπούς προφίλ.
            </p>
            <p className="mb-4">
              Μπορείτε να αλλάξετε τις επιλογές σας ανά πάσα στιγμή:{" "}
              <CookieSettingsButton />.
              Εναλλακτικά, μπορείτε να διαχειριστείτε ή να απενεργοποιήσετε τα cookies από τις ρυθμίσεις του προγράμματος περιήγησής σας. Σημειώστε ότι η απενεργοποίηση των αναγκαίων cookies ενδέχεται να επηρεάσει τη λειτουργικότητα της Ιστοσελίδας (π.χ. αδυναμία υποβολής της φόρμας επικοινωνίας).
            </p>
          </div>
