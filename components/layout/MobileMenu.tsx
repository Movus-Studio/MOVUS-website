    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-40 bg-movus-black"
        >
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between p-8 md:p-12 lg:p-20 pt-20 md:pt-28">
              {/* Top: two-column (Menu / Socials) */}
              <div className="grid grid-cols-[1fr_auto] gap-12 md:gap-24">
                {/* Menu column */}
                <div>
                  <p
