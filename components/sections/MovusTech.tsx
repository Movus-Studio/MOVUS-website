        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-10 lg:gap-20">
          ...
          <div className="space-y-5">
            ...
            <p
              ...
              style={{ fontSize: "var(--text-body-m)" }}
            >
              EMS που ενεργοποιεί το σώμα σου σε βάθος μέσα σε 30 λεπτά, εκεί που η κλασική προπόνηση δεν φτάνει. Συνεδρίες που συνδυάζουν θερμότητα, αρνητική πίεση, αρωματοθεραπεία και αναδόμηση κολλαγόνου. Το σώμα σου δουλεύει ενώ εσύ αποσυμφορείσαι.
            </p>
            <p
              className="tech-reveal text-white/65 leading-[1.7]"
              style={{ fontSize: "var(--text-body-m)" }}
